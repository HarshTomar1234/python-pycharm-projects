...
out_dir = 'D:/output_annotations/'
if not os.path.exists(out_dir):
    os.makedirs(out_dir)

file = minidom.parse('D:/task_keypoints-detector(pose detection)_annotations_2024_07_01_08_28_33_cvat for images 1.1/annotations.xml')
